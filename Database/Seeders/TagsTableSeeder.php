...
class TagsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Insert the data into the shop_tags table
        DB::table('shop_tags')->insert($tagRecords);
        ...
        $tagIds = DB::table('shop_tags')->pluck('id')->toArray();
        ...
        // Insert the data into the shop_product_tag table
        DB::table('shop_product_tag')->insert($productTagRecords);
    }
}
